...
Page({
  ...
  data: {
    ...
    rightcategory:[
      {
        vegetables_category_name:"a0",
        vegetables_category_varname:"value"
      },
      {
        vegetables_category_name:"a1",
        vegetables_category_varname:"aaaa"
      }
    ],
    rightitem:{
      aaaa:[
        {
          vegetable_varieties_id:1,
          vegetable_varieties_name:"胡建国2222",
          vegetable_varieties_img:"../../images/button/1.jpg",
          vegetable_varieties_price:10,
          vegetable_varieties_unit:1,
          vegetable_varieties_describe:"很好吃"
        }
      ],
      value:[
        {
          vegetable_varieties_id:1,
          vegetable_varieties_name:"胡建国",
          vegetable_varieties_img:"../../images/button/1.jpg",
          vegetable_varieties_price:10,
          vegetable_varieties_unit:1,
          vegetable_varieties_describe:"很好吃"
